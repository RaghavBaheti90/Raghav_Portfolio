    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Hi, I'm{' '}
            <span className="gradient-text">Raghav Baheti</span>
          </motion.h1>
          ...
          >
            Building beautiful, production-ready mobile applications with Flutter, Kotlin & Swift. 
          ...
          >
            {[
              ...
              { icon: Linkedin, href: 'https://linkedin.com/in/raghavbaheti01', label: 'LinkedIn' },
              { icon: Mail, href: 'mailto:work.raghavbaheti@gmail.com', label: 'Email' },
            ].map((social) => (
              <motion.a
                key={social.label}
                href={social.href}
                ...
                whileTap={{ scale: 0.95 }}
                className="p-3 rounded-xl bg-secondary/50 border border-border hover:border-primary/50 hover:bg-secondary transition-all duration-300"
